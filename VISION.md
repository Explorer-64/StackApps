...
- **Do not** turn **stackapps.app** into an **all-in-one SaaS suite** (single product that replaces invoicing, accounting, CRM, payroll *inside the directory*). Those capabilities stay **separate PWAs** on **their own domains**. That restraint is **product scope for the directory**, **not** a rejection of **SaaS** — **listed apps are SaaS**.
